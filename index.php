...
<body>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <input type="text" id="dictationAccuracy" name="dictationAccuracy" required><br><br>
        <script>  
            document.getElementById('dictationAccuracy').value='%';  
        </script>
        
        <label for="softwareAccuracy">软件正确率：</label>
        <input type="text" id="softwareAccuracy" name="softwareAccuracy" required><br><br>
        <script>  
        ...
        <textarea id="dictationScores" name="dictationScores" rows="4" cols="50" required></textarea><br><br>
        
        <label for="wordsToReview">需要注意复习的单词：</label><br>
        <textarea id="wordsToReview" name="wordsToReview" rows="2" cols="50" required>no信封中的单词</textarea><br><br>
